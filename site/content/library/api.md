...
> [a complete chunk row suppressed by an incomplete event](@/library/architecture.md#a-complete-chunk-row-suppressed-by-an-incomplete-event).
...
[on-demand snapshots](@/library/config-reference.md#on-demand-snapshots).
...
See [Operations Runbook](@/library/runbook.md#health-verdict-idle-vs-stalled) for the
alerting rules.
...
- [Adapter SDK](@/library/adapter-sdk.md)
