...
If your deployment does not provide these wrappers, see [Deployment](@/library/deployment.md) first and wire health/metrics/service controls before applying this runbook verbatim.
...
> [`wal_transport`](@/library/config-reference.md#wal-transport) for what that costs.
...
See [troubleshooting.md](@/library/troubleshooting.md) for detailed diagnosis procedures.
