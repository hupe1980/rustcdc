+++
title = "Deployment"
description = "Running rustcdc in production: process model, supervision, resource sizing and shutdown."
weight = 90
+++
...
For MySQL and SQL Server deployments, use the same runtime pattern with source-specific config and operational prerequisites from [config_reference.md](@/library/config-reference.md) and [runbook.md](@/library/runbook.md).
...
- [getting_started.md](@/library/getting-started.md)
- [config_reference.md](@/library/config-reference.md)
- [runbook.md](@/library/runbook.md)
- [troubleshooting.md](@/library/troubleshooting.md)
