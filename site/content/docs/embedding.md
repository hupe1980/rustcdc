...
> [the runbook](@/docs/embedded-operations.md).
...
Alert on exactly that; see [health verdict](@/docs/embedded-operations.md#health-verdict-idle-vs-stalled)
...
- [Reliability testing](@/docs/reliability-testing.md) — replay a captured stream inside your
  own test suite
- [Runbook](@/docs/embedded-operations.md) — what to alert on before this goes to production
