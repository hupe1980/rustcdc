...
# This stage only copies source files and produces recipe.json.
# It is invalidated only when Cargo.toml / Cargo.lock change, not on every
# source code edit — keeping the large "cook" layer intact.
