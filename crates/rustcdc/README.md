...
🚀 **[Getting started](https://hupe1980.github.io/rustcdc/docs/embedding/)** ·
🔧 **[API reference](https://docs.rs/rustcdc)**

> **Looking for the server?** This is the embeddable library. The configured binary and
> container image is [`rustcdc-server`](https://github.com/hupe1980/rustcdc/tree/main/crates/rustcdc-server),
> in the same repository and at the same version.
...
**Pre-1.0.** The public API may still change, and minor versions may contain breaking
changes; each one is listed in the
...
the **[getting started guide](https://hupe1980.github.io/rustcdc/docs/embedding/)**.
...
**The documentation compiles.** Every Rust block in this README and under `site/content/docs/` (repository root)
...
| | |
|---|---|
| [Getting started](https://hupe1980.github.io/rustcdc/docs/embedding/) | First pipeline, from an empty project to committed events |
